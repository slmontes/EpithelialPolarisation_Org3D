...
#include <iostream>
#include <math.h>
#include "EpithelialLayerPolarisationForce.hpp"
#include "IsNan.hpp"
...
EpithelialLayerPolarisationForce<SPACE_DIM>::EpithelialLayerPolarisationForce()
 ...
 */
template<unsigned SPACE_DIM>
c_vector<double, SPACE_DIM> EpithelialLayerPolarisationForce<SPACE_DIM>::cvector_multiplied(c_vector<double, SPACE_DIM> vec, double number)
{
 ...
 */
template<unsigned SPACE_DIM>
c_vector<double, SPACE_DIM> EpithelialLayerPolarisationForce<SPACE_DIM>::pol_to_cvector(double cell_theta, double cell_phi)
{
 ...
 */
template<unsigned SPACE_DIM>
std::pair<double, double> EpithelialLayerPolarisationForce<SPACE_DIM>::pt_to_pol(c_vector<double, SPACE_DIM> r, double dist)
{
 ...
 */
 template<unsigned SPACE_DIM>
 std::pair<double, double> EpithelialLayerPolarisationForce<SPACE_DIM>::pt_to_pol(c_vector<double, SPACE_DIM> r)
 {
  ...
  */
  template<unsigned SPACE_DIM>
  double EpithelialLayerPolarisationForce<SPACE_DIM>::pol_dot_product(double celli_theta,
                                                                        double celli_phi,
                                                                        double cellj_theta,
                                                                        double cellj_phi)
  {
   ...
   */
   template<unsigned SPACE_DIM>
   std::pair<double, double> EpithelialLayerPolarisationForce<SPACE_DIM>::unidirectional_polarization_force(double celli_theta,
                                                                                                              double celli_phi,
                                                                                                              double cellj_theta,
                                                                                                              double cellj_phi)
   {
   ...
   */
   template<unsigned SPACE_DIM>
   std::pair<double, double> EpithelialLayerPolarisationForce<SPACE_DIM>::bidirectional_polarization_force(double celli_theta,
                                                                                                             double celli_phi,
                                                                                                             double cellj_theta,
                                                                                                             double cellj_phi)
   {
   ...
   */
   template<unsigned SPACE_DIM>
   std::pair<double, double> EpithelialLayerPolarisationForce<SPACE_DIM>::EulerSolver_PolarisationAngles(double celli_theta,
                                                                                                             double celli_phi,
   ...
   */
   template<unsigned SPACE_DIM>
   c_vector<double, SPACE_DIM> EpithelialLayerPolarisationForce<SPACE_DIM>::bending_force(CellPtr p_celli,
                                                                                            double celli_theta,
                                                                                            double celli_phi,
                                                                                            double cellj_theta,
                                                                                            double cellj_phi,
    ...
    */
    template<unsigned SPACE_DIM>
    void EpithelialLayerPolarisationForce<SPACE_DIM>::AddForceContribution(AbstractCellPopulation<SPACE_DIM,SPACE_DIM>& rCellPopulation)//(AbstractCellPopulation<SPACE_DIM>& rCellPopulation)
    {
...
template class EpithelialLayerPolarisationForce<1>;
template class EpithelialLayerPolarisationForce<2>;
template class EpithelialLayerPolarisationForce<3>;

// Serialization for Boost >= 1.36
#include "SerializationExportWrapperForCpp.hpp"
EXPORT_TEMPLATE_CLASS_SAME_DIMS(EpithelialLayerPolarisationForce)
